...
import { ModaleStudentActions } from "../Modale/ModaleStudentActions";
...
export const ListStudent = () => {
  ...
  useEffect(() => {
    handlePerson.student.findAll().then((res) => {
  ...
  function remove(id: any) {
    handlePerson.student.remove(id).then((res) => {
      console.log(res);
  ...
  return (
    <div className="container mx-auto py-10">
      <h1 className="mb-5 text-2xl font-bold">Liste des Apprenants</h1>
